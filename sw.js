...
self.addEventListener('fetch', (event) => {
  ...
  if (isNavigationRequest(request) || isFreshFile(url)) { event.respondWith(networkFirst(request)); return; }
